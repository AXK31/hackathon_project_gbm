...
const Navbar = () => {
  ...
  return (
    <nav className="bg-black text-white p-4 flex justify-between items-center relative">
      <h1 className="text-xl font-bold text-blue-400"><img src="file:///home/shreya/Downloads/Cyan%20and%20Black%20Simple%20&%20Circular%20General%20Hospital%20Logo.png"></img></h1>
